...
|-------|--------|-------------|-------------------|
| **Clean Suit** | 1 | Factory-new, mirror-reflective. Post-crash: hairline fractures only | All 5 bright |
| **Light Wear** | 2–5 | Water stain rings, mud in boot treads, surface scratches (paint-deep). No structural damage | All 5 bright |
| **Mid-Mission** | 6–8 | Scratches exposing bare metal, visible dents, hairline cracks, first improvised repairs (copper wire) | All 5 still glow — surrounding plates damaged |
| **Heavy Wear** | 9–12 | Deep gouges with torn metal edges, cracked/collapsed plates, missing chunks, multiple improvised repairs. NOT just darker — physical damage | Some dark — emitter plates cracked |
...
> - Missing holographic accent nodes (WRONG — every suit has 5 glowing nodes: chest, both shoulders, both knees)
...
|---|---|---|
| **Holographic accent nodes** | 5 visible, glowing department color | Chest (flat hexagonal glow flush with plate — NOT a round disc or arc reactor), both shoulders, both knees |
...
- FIVE holographic accent nodes glow pale blue-white: one chest (largest), one each shoulder, one each knee — flat hexagonal glows flush with the armor surface — NOT round discs, NOT arc reactors
...
1. PRISTINE (Issue 1): Factory-new, mirror-reflective. All 5 nodes bright. Every panel line crisp.
2. LIGHT WEAR (Issues 2–5): Water stain rings on shoulder plates, mud caked in boot treads, a 2-inch surface scratch on right forearm. Nodes still bright.
3. MID-MISSION (Issues 6–8): Long scratch across right shoulder plate with paint scraped away showing darker metal. Visible dent in left forearm guard. Hairline crack through left knee plate. Specific soot fingerprints on thigh plates.
4. HEAVY WEAR (Issues 9–12): Deep diagonal gouge across left chest plate with metal visibly torn open. Cracked right shoulder sealed with crude adhesive. Chunk missing from left forearm guard edge. Impact dents with radial cracks on both knees. Copper wire wound around split hip seam. Physical damage everywhere — NOT just darker.
...
Woman, late thirties, sharp angular features, high cheekbones, dark brown skin, close-cropped silver-white hair. Athletic build, lean and precise. Command silver suit with brushed metallic finish, geometric panel lines like circuit paths, distinct armor plates at shoulders/chest/forearms, five pale blue-white holographic accent nodes (one chest, two shoulders, two knees), sidearm holstered at right hip, temple emitter near left eye, wing-pack stowed between shoulder blades.

Left to right:
1. PRISTINE: Command silver, factory-new, mirror-reflective. All 5 blue-white nodes bright. No damage. Full metallic sheen. Every panel line crisp and clean.
2. LIGHT WEAR: Same suit. A visible water stain ring on the left shoulder plate. Dried mud caked on both boot soles and lower shin guards. A 2-inch surface scratch across the right forearm plate — paint-deep, no metal exposed. All 5 nodes still bright.
3. MID-MISSION: Same suit. A long scratch across the right shoulder plate where the silver paint is scraped away showing darker gunmetal underneath. A visible dent in the left forearm guard where the metal is bent slightly inward. Soot fingerprints visible on the thigh plates. A hairline crack runs vertically through the left knee plate. Nodes still glow but the chest node has a faint flicker.
4. HEAVY WEAR: Same suit. A deep diagonal gouge across the left chest plate — the metal is visibly torn open showing internal layering. The right shoulder plate has a crack sealed with crude dark adhesive that contrasts against the silver. A chunk is missing from the left forearm guard edge. Both knees have impact dents with radial cracks spreading outward. Copper wire is wound around a split seam on the right hip. The suit is scratched and dented everywhere — this is physical damage, not just darkness. Chest node still glows through the damage. Right knee node is dark — the plate around it is cracked.
...
```
Character turnaround reference sheet. Four views of the same character on a plain neutral gray background: front, three-quarter, side profile, and back. Even studio lighting, no dramatic shadows. Full body, standing upright in a relaxed military at-ease pose. Same character as clean version — woman, late thirties, sharp features, dark brown skin, close-cropped silver-white hair. The suit retains all structural details from the clean version — same geometric panel lines, same armor plate segmentation at shoulders/chest/forearms, same brushed metallic texture, same five holographic accent nodes (chest, both shoulders, both knees) — now weathered over that structure. Her command silver suit shows specific physical damage — NOT just darker. A long scratch runs across the right shoulder plate where the silver paint is scraped away showing darker gunmetal metal underneath — the scratch has visible depth and direction. A visible dent in the left forearm guard where the metal is bent slightly inward from an impact. A hairline crack runs vertically through the left knee plate. Soot fingerprints are visible on the right thigh plate — individual finger marks, not a general darkening. The suit still catches light on undamaged surfaces — the silver is still silver where it isn't scratched. A faint holographic HUD glows near her left eye. The wing-pack has a surface scratch across its casing but seams still glow. All five holographic nodes still glow at full brightness — the nodes themselves are undamaged, it's the armor plates around them that show wear. NOT just darker — the suit has scratches, dents, and cracks while remaining silver-colored on undamaged areas. Consistent proportions and damage placement across all four views.
```
...
```
Character turnaround reference sheet. Four views of the same character on a plain neutral gray background: front, three-quarter, side profile, and back. Even studio lighting, no dramatic shadows. Full body, standing upright in a relaxed military at-ease pose but with fractionally heavier shoulders — the posture of sustained command. Same character as clean version — woman, late thirties, sharp features, dark brown skin, close-cropped silver-white hair. The suit retains all structural details from the clean version — same geometric panel lines, same armor plate segmentation at shoulders/chest/forearms, same brushed metallic texture — now showing heavy physical damage over that structure. Her command silver suit has heavy physical damage — NOT just darker, the suit is beaten up. A deep diagonal gouge across the left chest plate — the metal is visibly torn open showing darker internal layering, with the torn edge curled upward. The right shoulder plate has a crack sealed with crude dark adhesive — the adhesive is a visible blob contrasting against the silver. A chunk of metal is missing from the left forearm guard edge — you can see the gap. Both knee plates have impact dents with radial cracks spreading outward from the impact points — the metal is visibly deformed. Copper wire is wound around a split seam on the right hip where the suit material has separated. The sidearm holster has a visible scratch across its face. Wing-pack casing has a crack along one edge sealed with adhesive plus multiple deep scratches. The suit is still SILVER in color on undamaged areas — this is physical damage (scratches, dents, tears, missing pieces), NOT a color change. Three of the five holographic nodes still glow — the chest node pulses steadily. The left knee node flickers. The right knee node is dark because the plate around it is cracked through the emitter. NOT just darker — show torn metal, visible dents, cracks with separated edges, missing material. Consistent damage placement across all four views.
```
...
- FIVE holographic accent nodes glow warm copper-gold: one flat hexagonal glow at chest projector flush with plate (NOT a round disc — NOT an arc reactor), one each shoulder, one each knee
...
DEGRADATION ARC (4 phases, one-directional — suits are NEVER cleaned)
1. PRISTINE (Issue 1): Silver-copper shimmer, factory-new. All 5 nodes bright. Tool slots crisp and empty.
...
3. MID-MISSION (Issues 6–8): Wet-looking oil stains with drip lines on both forearm panels. Scorch mark on left shoulder — discolored brown-black splash with bubbled paint edges. Visible tear at right hip patched with wound copper wire. Victorian brass caliper jammed in a tool pouch.
4. HEAVY WEAR (Issues 9–12): Forearm tool slots visibly clogged with hardened grease. Brown leather strap stitched through punched holes around cracked left forearm plate. Right shoulder has dent with stress crack radiating from impact. One wing-pack antenna snapped off — broken stub visible. Deep scratches on both knees exposing bare metal.
...
Woman, early thirties, East Asian features, oval face, wiry build. Dark black hair in a functional knot. IMPORTANT: Silver-metallic base suit with warm copper shimmer — NOT solid copper. Brushed metallic finish, geometric panel lines, reinforced forearm panels with recessed tool slots, chest-mounted holographic projector, five copper-gold holographic accent nodes (one chest projector, two shoulders, two knees), tool belt with instruments, wing-pack with two sensor antennae.

Left to right:
1. PRISTINE: Silver-copper shimmer, factory-new. All 5 copper-gold nodes bright. Tool slots clean, all pouches organized. Full metallic sheen. Every tool slot crisp and empty.
2. LIGHT WEAR: Same suit. Dark oil fingerprints on both wrist joints — visible individual finger marks. A water stain ring on the upper left arm. Mud caked in the boot treads. A small scratch near the right tool slot. All 5 nodes still bright.
3. MID-MISSION: Same suit. Both forearm panels have wet-looking oil stains with drip lines running down from the tool slots toward the gloves. A visible scorch mark on the left shoulder — the metal is discolored brown-black in a splash pattern with bubbled paint at the edges. A tear in the suit material at the right hip patched with copper wire wound tightly — the wire is visible and contrasts against the suit. One tool pouch hangs open with a Victorian brass caliper jammed in where a fairy tool used to be. Nodes still glow but dimmer.
4. HEAVY WEAR: Same suit. The forearm tool slots are clogged with hardened grease — individual slot openings visibly blocked. A strip of brown leather is strapped around a crack in the left forearm plate — stitched through holes punched in the suit material. The scorch mark has a second burn crossing it. The right shoulder plate has a visible dent with a stress crack radiating from the impact point. One wing-pack antenna is snapped off — the broken stub is visible. Both knee plates have deep scratches exposing bare metal. Chest node still glows warm through the damage. Both knee nodes are dark — the plates around them are too damaged.
...
- FIVE holographic accent nodes glow emerald green: one flat hexagonal glow at chest flush with plate (NOT a round disc — NOT an arc reactor), one each shoulder, one each knee — BRIGHTER than other characters (more power routed to flight systems)
...
DEGRADATION ARC (4 phases, one-directional — suits are NEVER cleaned)
1. PRISTINE (Issue 1): Bright emerald shimmer, factory-new. All 5 nodes bright (brightest of squad). Satchel flat/empty. Flex panels pristine.
2. LIGHT WEAR (Issues 2–5): Black soot smear across chest — a hand-width streak with defined edges. Mud in boot treads. 1-inch scratch on right knee plate. Nodes still bright.
3. MID-MISSION (Issues 6–8): Visible tear in right forearm — suit material ripped open showing darker layer, copper wire wound through edges like stitches. Left knee plate scraped to bare metal. Satchel stuffed and bulging. Leather cord on wrist. Directional chimney soot streaks across chest.
4. HEAVY WEAR (Issues 9–12): Second tear on left shin patched with visible rectangle of rough canvas stitched through punched holes. Left knee flex panel bent at wrong angle. Brass button pinned through chest plate (hole punched in armor). Satchel overflowing. Wing-pack has hairline cracks along wing-fold seams. One knee node dark — plate too scraped.
...
Late teens/early twenties, lean androgynous build, light brown skin, wild bright golden blonde curly hair. Emerald metallic shimmer over silver base, sleeker/lighter suit than others, flex panels at elbows/knees/waist, five emerald holographic accent nodes (brighter than other characters — more power to flight systems), satchel at left hip, signaling device at right, wing-pack slightly larger than others.

Left to right:
1. PRISTINE: Bright emerald shimmer, factory-new. All 5 emerald nodes bright (brightest of the squad). Satchel flat, empty. Full metallic sheen. Flex panels at joints pristine.
2. LIGHT WEAR: Same suit. Black soot smear across the chest — a visible hand-width streak with defined edges, not a general darkening. Mud caked in boot treads. A 1-inch scratch on the right knee plate. Satchel still mostly flat. All 5 nodes still bright.
3. MID-MISSION: Same suit. A tear in the right forearm — the suit material is visibly ripped open showing a darker layer underneath, with copper wire wound through the edges holding it closed like stitches. The left knee plate has a deep scrape where the emerald paint is completely gone, showing bare brushed metal. Satchel is stuffed full and bulging at the seams. A leather cord tied around the left wrist. Chimney soot in specific streaks across chest and between shoulder blades — directional, from flying through smoke. Nodes still bright through the damage.
4. HEAVY WEAR: Same suit. The right forearm copper-wire repair is joined by a second tear on the left shin — this one patched with a visible rectangle of rough canvas stitched crudely through holes in the suit. The left knee flex panel is visibly deformed — bent at a wrong angle. A brass button is pinned through the chest plate near the node — a hole punched through the armor to mount it. Two leather cord bracelets. Satchel overflowing with bits of Victorian junk poking out. Wing-pack has visible hairline cracks along two of the wing-fold seam lines. Chest and shoulder nodes still bright (flight systems stay powered). One knee node flickers, the other is dark — the plate around it is too scraped to transmit.
...
- FIVE holographic accent nodes glow crimson-red: one flat hexagonal glow at chest plate flush with surface (NOT a round disc — NOT an arc reactor), one each pauldron edge, one each knee
...
DEGRADATION ARC (4 phases, one-directional — suits are NEVER cleaned)
1. PRISTINE (Issue 1): Deep crimson, factory-new. All 5 nodes bright. Pauldrons sharp-edged, chest plate unblemished. Rifle stock clean.
2. LIGHT WEAR (Issues 2–5): Water stain ring on left pauldron top. Mud on boot soles and shin armor. Surface scratch across left pauldron ridge. Rifle stock dusty. Nodes still bright.
3. MID-MISSION (Issues 6–8): Long diagonal scratch across chest plate right-shoulder-to-left-hip — crimson paint scraped away showing darker metal. Left pauldron dented — angular edge bent inward from impact. Wing-pack crack sealed with dark adhesive. Rifle stock has triangular chip missing. Nodes pulse unevenly.
4. HEAVY WEAR (Issues 9–12): Three parallel claw-mark gouges across right chest plate — metal torn and curled at edges. Left pauldron collapsed flat — metal crumpled against shoulder. Right vambrace cracked full length with halves slightly separated. Impact craters on both knees with radial cracks. Paint remains only on raised plate edges — everywhere else scraped to bare metal.
...
Woman, broad-shouldered, muscular with strong athletic female build. Pale skin, defined cheekbones, firm jaw, copper-red buzz cut. MOST heavily armored suit — deep crimson metallic shimmer over silver base, angular pauldrons projecting outward, reinforced chest plate, vambrace forearm guards, five crimson holographic accent nodes (one chest, two pauldron edges, two knees), rifle magnetically clamped to back, sidearm at thigh, heavy utility belt.

Left to right:
1. PRISTINE: Deep crimson, factory-new. All 5 crimson nodes bright. Heavy armor pristine, angular pauldrons sharp-edged, chest plate unblemished. Full metallic sheen. Rifle stock clean.
2. LIGHT WEAR: Same suit. A water stain ring on the top of the left pauldron. Mud caked on boot soles and lower shin armor. A surface scratch across the left pauldron's raised ridge — paint-deep. Rifle stock has a thin dust coating. All 5 nodes still bright.
3. MID-MISSION: Same suit. A long diagonal scratch running from the right shoulder to the left hip across the chest plate — the crimson paint is scraped away in a visible line showing darker metal underneath. The left pauldron has a visible dent — the angular edge is bent inward from an impact. The wing-pack casing has a crack sealed with a dark smear of adhesive that contrasts against the crimson. The rifle stock has a visible chip — a triangular piece missing from one edge. Nodes pulse unevenly — some steady, some flickering.
4. HEAVY WEAR: Same suit. Three fresh parallel claw-mark gouges across the right chest plate — deep enough that the metal is torn and curled at the edges, showing internal layering. The left pauldron is visibly collapsed — the angular projection is bent flat against the shoulder, the metal crumpled. The right vambrace has a crack running its full length — the two halves are slightly separated. Both knee plates have impact craters with radial stress cracks. Crimson paint remains only on raised plate edges — everywhere else is scratched to bare metal. Chest node steady. One pauldron node steady, other pauldron node flickers (the collapsed one). Both knee nodes dark — plates too damaged.
...
- FIVE holographic accent nodes glow blue-violet: one flat hexagonal glow at chest flush with plate (NOT a round disc — NOT an arc reactor), one each shoulder, one each knee
...
DEGRADATION ARC (4 phases, one-directional — suits are NEVER cleaned)
1. PRISTINE (Issue 1): Deep sapphire-violet shimmer, factory-new. All 5 nodes bright. Lenses floating clean. Filament bright. Scanner glowing. Every panel line crisp.
2. LIGHT WEAR (Issues 2–5): Dark ink stains on right thumb and first two fingertips — visible individual marks. Yellow-green pollen smudge on left knee in specific oval shape. Mud in boot treads. Nodes still bright.
3. MID-MISSION (Issues 6–8): Ink stains spread to right hand and wrist — dark splotches with drip patterns. Sample pouch flap open with pressed flower visible. Scanner housing has visible diagonal crack across projector lens. Braid filament slightly dimmer.
4. HEAVY WEAR (Issues 9–12): Ink stains reach right mid-forearm in layered splotches. 3-inch scratch on left shoulder with violet paint scraped to silver — her first combat contact. Scanner has two crossing cracks — display visibly distorts. One eye lens has hairline crack creating rainbow refraction line. Multiple pouches open with document corner poking out. Braid filament fading.
...
Woman, late twenties, South Asian features, warm brown skin, large dark eyes, long dark hair in a single braid threaded with luminous blue-violet filament. Holographic lenses hovering at eyes (gold-toned). Sapphire-violet suit with silver base, lighter/less armored than others, five blue-violet holographic accent nodes (one chest, two shoulders, two knees), medical scanner module on left forearm, utility belt with sample pouches, wing-pack with sensor filaments.

Left to right:
1. PRISTINE: Deep sapphire-violet shimmer, factory-new. All 5 blue-violet nodes bright. Holographic lenses floating clean at eyes. Braid filament bright. Scanner module glowing. All pouches organized. Every panel line crisp.
2. LIGHT WEAR: Same suit. Dark ink stains on the right thumb and first two fingertips — visible individual marks, not a general darkening. A yellow-green pollen smudge on the left knee plate in a specific oval shape. Mud in boot treads. A water stain ring on the left shoulder. All 5 nodes still bright. Lenses clean.
3. MID-MISSION: Same suit. Ink stains have spread from fingers to cover the right hand and wrist — dark splotches with visible drip patterns. Pollen smudge on left knee is ground in. One sample pouch flap hangs open with a small pressed flower visible inside. The medical scanner housing on the left forearm has a visible crack — a single line running diagonally across the projector lens. Braid filament pulses slightly dimmer. Lenses have a faint haze. Nodes still glow but dimmer.
4. HEAVY WEAR: Same suit. Ink stains reach the right mid-forearm in layered splotches — weeks of document handling. Pollen residue on both knee plates. A 3-inch scratch on the left shoulder plate where the violet paint is scraped away showing silver underneath — her first real combat contact. Multiple sample pouches hang open, one has a folded document corner poking out. The scanner housing has two cracks crossing each other — the holographic display visibly distorts when active. One holographic eye lens has a hairline crack creating a visible rainbow refraction line across it. Braid filament noticeably dimmer — the luminous thread is fading. Chest and shoulder nodes dimmed but steady. One knee node flickers, other faint.
...
> **Detail check:** ☐ 5 blue-violet holographic nodes visible (chest, shoulders, knees) ☐ Holographic lenses hovering at eyes (gold-toned) ☐ Luminous filament in braid (blue-violet) ☐ Panel lines across all surfaces ☐ Medical scanner module on left forearm glowing ☐ Utility belt with visible instruments ☐ Wing-pack with sensor filaments ☐ Brushed metallic texture
